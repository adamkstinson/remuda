...
- `opencode.json` and `.mcp.json` wire up `planet-mcp` (`https://mcp.example.com/mcp`, your key in `X-Plane-Key`). planet-mcp holds no credential and forwards your key — your project membership in Plane is your scope.
